...
public class EmailServiceImpl implements EmailService {
    ...
    public void send(EmailMessage message) {
        log.info("Prepearing mail message to be sent.");
        ...
        try {
            ...
            log.debug("While sending the mail the error occured.");
    ...
    public void send(AttachmentMailMessage message) {
        log.info("Prepearing mail mime-message to be seht.");
        ...
        try {
            ...
            log.debug("While preparation of mime-message the error occured.");
            log.debug("Mime message: {}", mimeMessage);
            throw new MailSenderException("Something when wrong while preparation of mime-message", e);
        } catch (MailException e) {
            log.debug("While sending the mail with the mime-message the error occurred.");
            log.debug("Mime essage message: {}", mimeMessage);
